...
Fret.prototype.display = function() {
  ...
  // Check how many times 12 goes into the id
  // this.note.id % 12
  // round off the result
  // change to that octave index color in colors array

  if (this.active) {
    if (this.active && this.note.id <= 12) {
  ...
  if (this.playing) {
    if (this.playing && this.note.id <= 12) {
